...
public class BlockPowerCondenser  extends BlockContainer{
	public BlockPowerCondenser() {
		super(1005,6,Material.tnt);
		setCreativeTab(CommonProxy.CTAB);
		setBlockName("pPowerCondenser");
	}
	 ...
	 */
       ...
       //code to open gui explained later
        player.openGui(Plasmaticraft.instance, 0, world, x, y, z);
               return true;
       }
